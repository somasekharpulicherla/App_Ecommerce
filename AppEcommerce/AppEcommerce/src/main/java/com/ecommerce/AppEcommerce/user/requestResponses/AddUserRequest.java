...
public class AddUserRequest{
	...
	@Pattern(regexp = "^[a-zA-Z]*$", message = "First Name must contain only alphabets and numbers")
	private String firstName;
	
	@NotBlank(message="Last Name can not be blank")
	@Pattern(regexp = "^[a-zA-Z]*$", message = "lastName must contain only alphabets and numbers")
	@Size(min = 1, max = 50, message = "lastName must be less than 50 characters")
